export const apoiadoresData = [
  { 
    ...
    detalhes: {
      ...
      membros: [
        {
          nome: "Dra. Helena Tavares",
          papel: "Especialista em Trauma Infantil",
          historia: "Helena viu de perto o impacto do abandono em sua própria comunidade. Hoje, ela senta no tapete da sala de ludoterapia e usa brinquedos para ajudar crianças a verbalizarem dores indescritíveis. Seu abraço já evitou que dezenas de jovens desistissem da própria vida.",
          foto: "/image/Apoiadores/psicologos/Mulher.png"
        },
        {
          nome: "Dr. Ricardo Mendes",
          papel: "Terapeuta Familiar",
          historia: "Ricardo foca no núcleo familiar. Ele atende mães sobrecarregadas e pais perdidos no desemprego. Uma vez, atendeu um adolescente que não falava há meses; após três meses de sessões de escuta paciente e empatia genuína, Ricardo ouviu dele o primeiro 'obrigado'.",
          foto: "/image/Apoiadores/psicologos/homem.png"
        }
      ]
    }
  },
  ...
  { 
    ...
    detalhes: {
      ...
      membros: [
        {
          nome: "Projeto Formando Campeões",
          papel: "Esporte e Inclusão",
          historia: "Vários de nossos meninos chegavam aos treinos com fome, sem chuteira, mas com os olhos brilhando de esperança de ser o próximo ídolo. Nossos treinadores voluntários abraçaram a causa, doaram calçados e muitas vezes o próprio almoço, provando que o maior gol que eles poderiam marcar era salvar aqueles jovens das ruas.",
          foto: "/image/Apoiadores/escola_de_futibool/Gemini_Generated_Image_3iqb1e3iqb1e3iqb.png"
        }
      ]
    }
  },
  { 
    ...
    detalhes: {
      ...
      membros: [
        {
          nome: "Mestre Voluntária",
          papel: "Professora de Artes Marciais",
          historia: "Nossa mestre quebrou barreiras e estereótipos. Ela acolheu meninas assustadas e meninos revoltados. Com pulso firme, mas coração gigante, ela ensina no tatame que todos têm direito de se defender das injustiças da vida. Suas aulas transformaram jovens retraídos em líderes dentro de suas comunidades.",
          foto: "/image/Apoiadores/Luta/mulher_mestre.png"
        }
      ]
    }
  },
  { 
    ...
    detalhes: {
      ...
      membros: [
        {
          nome: "Professores do Instituto",
          papel: "Reforço e Alfabetização",
          historia: "Nunca esqueceremos o dia em que uma de nossas alunas mais velhas, com 14 anos, conseguiu ler um parágrafo inteiro sozinha pela primeira vez. A professora chorou junto com ela. Esse é o nível de dedicação: professores que sacrificam seus finais de semana para garantir que nenhuma criança do Instituto aceite menos do que ela merece sonhar.",
          foto: "/image/Apoiadores/Professores/professora.JPG"
        }
      ]
    }
  }
